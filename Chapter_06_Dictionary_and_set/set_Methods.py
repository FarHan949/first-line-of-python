...
symmetric_difference_set = info.symmetric_difference(anotherInfo)   # to get the symmetric difference of two sets use this method and it will return a set with  elements
